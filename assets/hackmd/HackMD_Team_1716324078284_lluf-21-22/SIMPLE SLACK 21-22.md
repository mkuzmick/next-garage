---
title: SIMPLE SLACK 21-22

---

# SIMPLE SLACK 21-22

notes for LLUFs who'd like to make a Slack app.
...
* create slack app at api.slack.com
    ...
    * turn on socket mode to generate an App Token (give it a name you'll remember when you are prompted)
* add to .env
```
...
```
* then make sure that you are "listening" for message events. Go to Event Subscriptions and subcribe to as many as you want, but you'll probably want at least these:
    * app_home_opened
    * message.channels
    * message.im
    * message.mpim
...
* create the slash command in the api.slack.com interface
* 
